...
public class ABOpening {
    ...
    public char[] minMax(char[] board, int ply, int a, int b) {
        if(ply == 0)
            positions_evaluated++;
        else if(ply > 0) {
            ply--;
            ...
            for(char[] child : childNodes){
                char[] maxChoice = maxMin(child, ply, a, b);
    ...
    public char[] maxMin(char[] board, int ply, int a, int b) {
        if(ply == 0) {
            positions_evaluated++;
        }else if(ply > 0) {
            ply --;
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            char[] result = open.maxMin(board, ply, a, b);
            ...
            System.out.println("MiniMax estimate : " + open.ab_estimate);
            ...
            String out5 = "MiniMax estimate : " + String.valueOf(open.ab_estimate) + "\n";
